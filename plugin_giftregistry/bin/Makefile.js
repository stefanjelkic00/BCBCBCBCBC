...
target.compileFonts = function () {
    var fontsDir = 'cartridges/plugin_giftregistry/cartridge/static/default/fonts';
    mkdir('-p', fontsDir);
    cp('-r', 'node_modules/font-awesome/fonts/', 'cartridges/plugin_giftregistry/cartridge/static/default');
...
target.release = function (args) {
    ...
    if (['patch', 'minor', 'major'].indexOf(type) >= 0) {
        ...
        var propertiesFileName = path.resolve('./cartridges/plugin_giftregistry/cartridge/templates/resources/version.properties')
